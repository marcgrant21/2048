...
class GameBoard(tk.Frame):
    def __init__(self, parent, rows=4, columns=4, size=150, color="#000000", background_color="#00bfff"):
        ...
        self.score_text = self.canvas.create_text(200, rows * size + 100, text=("Score:", self.score), font=(
...
def put(game_board, key, number, row=0, column=0):
    ...
    return True,game_board.canvas.coords(key, x0, y0)
